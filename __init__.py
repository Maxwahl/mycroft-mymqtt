...
__author__ = 'jamiehoward430/JonStratton/Maxwahl'
...
class mymqttskill(MycroftSkill):
    ...
    def __init__(self):
        ...
        self.mqttc = mqtt.Client("MycroftAI", True, None, mqtt.MQTTv311)
    ...
    def __build_single_command(self):
        intent = IntentBuilder("mymqttIntent").require("CommandKeyword").require("ModuleKeyword").require(
            "ActionKeyword").build()
